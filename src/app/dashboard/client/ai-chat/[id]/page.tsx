              ...
              message.talents.length > 0 && (
                <div className='md:col-span-3'>
                  <div className='grid grid-cols-2 gap-4'>
                    {message.talents.map((profile, idx) => {
                      const imageUrl = profile.images?.[0]
                        ? `${BASE_URL}${profile.images[0]}`
                        : "/placeholder.svg";

                      const isLast =
                        idx === message.talents!.length - 1 &&
                        message.talents!.length > 2;
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className='relative bg-[#404145] rounded-lg overflow-hidden group cursor-pointer'>
                            ...
                            {/* Overlay for last card when more than 2 */}
                            {isLast && (
                            ...
                            <div className='absolute inset-0 bg-linear-to-t from-black/90 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-end p-3 text-white text-xs'>
...
//                       <div className='text-[#2563EB] text-2xl shrink-0'>📋</div>
