...
export default function AIDynamicPage() {
  ...
  const roles: AvailableRole[] = availableRole?.data ?? [];
...
//     skip: !jobId,
//   });
//   const [assignRoleMutation] = useAssignRoleMutation(); // body data: {
//   //     "job_id": 75,
//   //     "talent_id": 2,
//   //     "role_id": 1
//   // }
...
//                                     here will be a button that open the role and can asiign role to specific talent
