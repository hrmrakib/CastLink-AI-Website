    ...
    <div className='relative w-full overflow-hidden'>
      ...
      <div className='absolute inset-0 flex items-center'>
        <div className='w-full px-6 sm:px-10 md:px-14 lg:px-16 max-w-[55%] sm:max-w-[50%]'>
          ...
          {/* CTA Button */}
          <button className='bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white font-semibold px-6 sm:px-8 py-3 sm:py-3.5 rounded-xl text-sm sm:text-base transition-all duration-200 hover:shadow-lg hover:shadow-blue-600/30 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer'>
            Get Started
          </button>
        </div>
      </div>
